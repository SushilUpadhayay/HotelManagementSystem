...
public class CreateAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("                       Welcome \n         Upadhayay Luxury Suites\n Experience Elegannce and Comfort");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton1.isSelected() == true)
        {
            ...
            // create another createAccountSection for the employee
            // and insert that data in the database
        }
        else if(jRadioButton2.isSelected() == true)
        {
            UserType = "Employee";
            new CreateAccountEmployee().setVisible(true);
            // create another createAccountSection for the customer
            // and insert that data in the database    
        }
        else
        {
