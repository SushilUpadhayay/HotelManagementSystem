...
public class CreateAccountEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Create a Employee Login Account");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager", "Cook", "Waiter", "Bouncer", "Receptionist", "Personal Chauffer", "Room Service", "Valley", " ", " ", " " }));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("Department: ");

        jComboBox2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cook", "Security", "Management", "Account", "Bar", "Service", " " }));
        ...
        jLabel8.setText("Rewrite Password: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!Gender.equals("") && !Name.equals("")&& !Gmail.equals("")&& !Age.equals("")&& !Password.equals("") && !Password2.equals("") && !Role.equals("") && !Department.equals("")) // user needs to enter all of the textfields 
        {
            if(Password.equals(Password2))
            {
               ...
               {  
                ...
                String sql = "SELECT * FROM EmployeeAccount WHERE Gmail = '" + Gmail + "'";// here Gmail of each user is unique
                ResultSet rs = st.executeQuery(sql);
                if(rs.next()) // if the gmail is already used then we can't accept that gmail
                {
                  JOptionPane.showMessageDialog(this, "Your Gmail has been already used");
                }
                else
                {
                   // Corrected INSERT statement
                   String sql2 = "INSERT INTO EmployeeAccount (Name, Gmail, Age, Gender, Department, Role, Shift, Salary, Password) VALUES ('"
                                                                                   + Name + "', '" + Gmail + "', '" + Age + "', '" + Gender + "', '" 
                                                                                   + Department + "', '" + Role + "', '" + Shift + "', " + Salary + ", '" + Password + "')";

                   st.executeUpdate(sql2);
                   JOptionPane.showMessageDialog(this, "Your Employee Account has been sucessfully created.");
                }
                con.close();
               }
                catch(Exception e)
            ...
            {
                JOptionPane.showMessageDialog(this, "Passwords do not match. Re-enter password."); 
            }
        }
        else
        {
